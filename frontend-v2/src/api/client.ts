...
export interface LlmServiceInfo{name:string;base_url:string;api_key:string;has_api_key?:boolean;is_builtin?:boolean;type:LlmServiceType;model:string;enable:boolean;extra_headers:Record<string,string>;provider_params?:Record<string,unknown>;temperature?:number|null;context_window_tokens?:number;reserve_output_tokens?:number;compact_trigger_ratio?:number;compact_summary_max_tokens?:number;max_concurrency?:number;requests_per_minute?:number;}
