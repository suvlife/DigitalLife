...
.room-layout{display:grid;grid-template-columns:minmax(180px,240px) minmax(0,1fr) minmax(220px,280px);gap:12px;min-height:clamp(620px,72vh,980px);align-items:stretch}
.room-info-column{overflow:auto;padding:14px;font-size:12px;line-height:1.55}
.room-info-column h3{margin:0 0 10px;font-size:14px}.compact-members{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-top:14px}
.discussion-panel{display:flex;min-width:0;flex-direction:column}.discussion-panel :deep(.dialogue-timeline){flex:1;min-height:460px;overflow:auto;font-size:13px;line-height:1.55}
@media(max-width:1100px){.room-layout{grid-template-columns:1fr}.room-info-column{display:none}}
</style>
<style scoped>
