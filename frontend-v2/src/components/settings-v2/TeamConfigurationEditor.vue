...
function addRoom(){roomDrafts.value.push({id:0,name:'',i18n:{},type:'group',initial_topic:'',max_rounds:10,agent_ids:[],agents:[],biz_id:null,tags:[]});}
